...
export const ProductOptionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductOptionSelect> = z.object({
...
export const ProductOptionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    productId: z.boolean().optional(),
    groupId: z.boolean().optional(),
    product: z.boolean().optional(),
...
export const ProductOptionFindFirstOrThrowSchema: z.ZodType<Prisma.ProductOptionFindFirstOrThrowArgs> = z.object({ select: ProductOptionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductOptionIncludeObjectSchema.optional()), orderBy: z.union([ProductOptionOrderByWithRelationInputObjectSchema, ProductOptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductOptionWhereInputObjectSchema.optional(), cursor: ProductOptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductOptionScalarFieldEnumSchema, ProductOptionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductOptionFindFirstOrThrowArgs>;

export const ProductOptionFindFirstOrThrowZodSchema = z.object({ select: ProductOptionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductOptionIncludeObjectSchema.optional()), orderBy: z.union([ProductOptionOrderByWithRelationInputObjectSchema, ProductOptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductOptionWhereInputObjectSchema.optional(), cursor: ProductOptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductOptionScalarFieldEnumSchema, ProductOptionScalarFieldEnumSchema.array()]).optional() }).strict();