...
export const OptionValueFindManySelectSchema: z.ZodType<Prisma.OptionValueSelect> = z.object({
...
export const OptionValueFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    group: z.boolean().optional(),
    groupId: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const OptionValueFindManySchema: z.ZodType<Prisma.OptionValueFindManyArgs> = z.object({ select: OptionValueFindManySelectSchema.optional(), include: z.lazy(() => OptionValueIncludeObjectSchema.optional()), orderBy: z.union([OptionValueOrderByWithRelationInputObjectSchema, OptionValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: OptionValueWhereInputObjectSchema.optional(), cursor: OptionValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OptionValueScalarFieldEnumSchema, OptionValueScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OptionValueFindManyArgs>;

export const OptionValueFindManyZodSchema = z.object({ select: OptionValueFindManySelectSchema.optional(), include: z.lazy(() => OptionValueIncludeObjectSchema.optional()), orderBy: z.union([OptionValueOrderByWithRelationInputObjectSchema, OptionValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: OptionValueWhereInputObjectSchema.optional(), cursor: OptionValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OptionValueScalarFieldEnumSchema, OptionValueScalarFieldEnumSchema.array()]).optional() }).strict();