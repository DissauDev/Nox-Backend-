...
export const CouponRedemptionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CouponRedemptionSelect> = z.object({
...
export const CouponRedemptionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    coupon: z.boolean().optional(),
    couponId: z.boolean().optional(),
    userId: z.boolean().optional(),
...
export const CouponRedemptionFindFirstOrThrowSchema: z.ZodType<Prisma.CouponRedemptionFindFirstOrThrowArgs> = z.object({ select: CouponRedemptionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CouponRedemptionIncludeObjectSchema.optional()), orderBy: z.union([CouponRedemptionOrderByWithRelationInputObjectSchema, CouponRedemptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: CouponRedemptionWhereInputObjectSchema.optional(), cursor: CouponRedemptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CouponRedemptionScalarFieldEnumSchema, CouponRedemptionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CouponRedemptionFindFirstOrThrowArgs>;

export const CouponRedemptionFindFirstOrThrowZodSchema = z.object({ select: CouponRedemptionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CouponRedemptionIncludeObjectSchema.optional()), orderBy: z.union([CouponRedemptionOrderByWithRelationInputObjectSchema, CouponRedemptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: CouponRedemptionWhereInputObjectSchema.optional(), cursor: CouponRedemptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CouponRedemptionScalarFieldEnumSchema, CouponRedemptionScalarFieldEnumSchema.array()]).optional() }).strict();