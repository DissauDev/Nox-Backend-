...
export const CouponRedemptionFindFirstSelectSchema: z.ZodType<Prisma.CouponRedemptionSelect> = z.object({
...
export const CouponRedemptionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    coupon: z.boolean().optional(),
    couponId: z.boolean().optional(),
    userId: z.boolean().optional(),
