...
import { OptionValueCreateNestedManyWithoutProductRefInputObjectSchema as OptionValueCreateNestedManyWithoutProductRefInputObjectSchema } from './OptionValueCreateNestedManyWithoutProductRefInput.schema'
...
const makeSchema = () => z.object({
  ...
  OptionValue: z.lazy(() => OptionValueCreateNestedManyWithoutProductRefInputObjectSchema).optional()
}).strict();
export const ProductCreateWithoutOrderItemInputObjectSchema: z.ZodType<Prisma.ProductCreateWithoutOrderItemInput> = makeSchema() as unknown as z.ZodType<Prisma.ProductCreateWithoutOrderItemInput>;
export const ProductCreateWithoutOrderItemInputObjectZodSchema = makeSchema();
