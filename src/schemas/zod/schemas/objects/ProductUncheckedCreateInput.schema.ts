...
const makeSchema = () => z.object({
  ...
  options: z.lazy(() => ProductOptionUncheckedCreateNestedManyWithoutProductInputObjectSchema),
  OrderItem: z.lazy(() => OrderItemUncheckedCreateNestedManyWithoutProductInputObjectSchema),
  OptionValue: z.lazy(() => OptionValueUncheckedCreateNestedManyWithoutProductRefInputObjectSchema)
}).strict();
