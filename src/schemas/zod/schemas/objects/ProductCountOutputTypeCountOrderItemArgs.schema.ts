...
export const ProductCountOutputTypeCountOrderItemArgsObjectSchema = makeSchema();
export const ProductCountOutputTypeCountOrderItemArgsObjectZodSchema = makeSchema();
