...
const makeSchema = () => z.object({
  ...
  options: z.lazy(() => ProductOptionCreateNestedManyWithoutProductInputObjectSchema),
  OrderItem: z.lazy(() => OrderItemCreateNestedManyWithoutProductInputObjectSchema),
  OptionValue: z.lazy(() => OptionValueCreateNestedManyWithoutProductRefInputObjectSchema)
}).strict();
