...
export const ProductCountOutputTypeCountOptionsArgsObjectSchema = makeSchema();
export const ProductCountOutputTypeCountOptionsArgsObjectZodSchema = makeSchema();
