...
export const ProductOptionValueFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductOptionValueSelect> = z.object({
...
export const ProductOptionValueFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    productOptionId: z.boolean().optional(),
    valueId: z.boolean().optional(),
    productOption: z.boolean().optional(),
...
export const ProductOptionValueFindFirstOrThrowSchema: z.ZodType<Prisma.ProductOptionValueFindFirstOrThrowArgs> = z.object({ select: ProductOptionValueFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductOptionValueIncludeObjectSchema.optional()), orderBy: z.union([ProductOptionValueOrderByWithRelationInputObjectSchema, ProductOptionValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductOptionValueWhereInputObjectSchema.optional(), cursor: ProductOptionValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductOptionValueScalarFieldEnumSchema, ProductOptionValueScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductOptionValueFindFirstOrThrowArgs>;

export const ProductOptionValueFindFirstOrThrowZodSchema = z.object({ select: ProductOptionValueFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductOptionValueIncludeObjectSchema.optional()), orderBy: z.union([ProductOptionValueOrderByWithRelationInputObjectSchema, ProductOptionValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductOptionValueWhereInputObjectSchema.optional(), cursor: ProductOptionValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductOptionValueScalarFieldEnumSchema, ProductOptionValueScalarFieldEnumSchema.array()]).optional() }).strict();