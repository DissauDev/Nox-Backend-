...
export const ProductOptionValueFindFirstSelectSchema: z.ZodType<Prisma.ProductOptionValueSelect> = z.object({
...
export const ProductOptionValueFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    productOptionId: z.boolean().optional(),
    valueId: z.boolean().optional(),
    productOption: z.boolean().optional(),
...
export const ProductOptionValueFindFirstSchema: z.ZodType<Prisma.ProductOptionValueFindFirstArgs> = z.object({ select: ProductOptionValueFindFirstSelectSchema.optional(), include: z.lazy(() => ProductOptionValueIncludeObjectSchema.optional()), orderBy: z.union([ProductOptionValueOrderByWithRelationInputObjectSchema, ProductOptionValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductOptionValueWhereInputObjectSchema.optional(), cursor: ProductOptionValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductOptionValueScalarFieldEnumSchema, ProductOptionValueScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductOptionValueFindFirstArgs>;

export const ProductOptionValueFindFirstZodSchema = z.object({ select: ProductOptionValueFindFirstSelectSchema.optional(), include: z.lazy(() => ProductOptionValueIncludeObjectSchema.optional()), orderBy: z.union([ProductOptionValueOrderByWithRelationInputObjectSchema, ProductOptionValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductOptionValueWhereInputObjectSchema.optional(), cursor: ProductOptionValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductOptionValueScalarFieldEnumSchema, ProductOptionValueScalarFieldEnumSchema.array()]).optional() }).strict();