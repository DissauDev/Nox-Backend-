...
export const StoreConfigFindManySelectSchema: z.ZodType<Prisma.StoreConfigSelect> = z.object({
...
export const StoreConfigFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    taxEnabled: z.boolean().optional(),
    taxPercent: z.boolean().optional(),
    taxFixed: z.boolean().optional(),
...
export const StoreConfigFindManySchema: z.ZodType<Prisma.StoreConfigFindManyArgs> = z.object({ select: StoreConfigFindManySelectSchema.optional(),  orderBy: z.union([StoreConfigOrderByWithRelationInputObjectSchema, StoreConfigOrderByWithRelationInputObjectSchema.array()]).optional(), where: StoreConfigWhereInputObjectSchema.optional(), cursor: StoreConfigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StoreConfigScalarFieldEnumSchema, StoreConfigScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StoreConfigFindManyArgs>;

export const StoreConfigFindManyZodSchema = z.object({ select: StoreConfigFindManySelectSchema.optional(),  orderBy: z.union([StoreConfigOrderByWithRelationInputObjectSchema, StoreConfigOrderByWithRelationInputObjectSchema.array()]).optional(), where: StoreConfigWhereInputObjectSchema.optional(), cursor: StoreConfigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StoreConfigScalarFieldEnumSchema, StoreConfigScalarFieldEnumSchema.array()]).optional() }).strict();