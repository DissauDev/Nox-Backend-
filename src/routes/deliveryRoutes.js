...
const { getDeliveryQuote,cancelDeliveryController,getDoorDashDelivery } = require('../controllers/delivery/deliveryController');
...
router.get("/delivery/doordash/:externalId", getDoorDashDelivery);
